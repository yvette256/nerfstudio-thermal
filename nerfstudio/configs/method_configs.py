...
from nerfstudio.models.thermal_nerfacto import ThermalNerfactoModelConfig
...
descriptions = {
    ...
    "thermal-nerfacto": "Nerfacto with RGB and thermal data.",
...
method_configs["thermal-nerfacto"] = TrainerConfig(
    method_name="thermal-nerfacto",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
